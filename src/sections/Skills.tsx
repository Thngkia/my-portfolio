...
const ProgressBar = ({ percentage }) => (
  <div className="w-full pt-1">
    ...
    <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-pink-200">
      <div className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-pink-500 w-1/2"></div>
    </div>
  </div>
)
    ...
    <section className="text-gray-600 body-font" id={id}>
      <div className="container px-5 py-24 mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-y-4 sm:-m-4 -mx-4 -mb-10 -mt-4">
          <SkillCard skill={"HTML"} percentage="100" />
          <SkillCard skill={"CSS"} percentage="90" />
          <SkillCard skill={"JS"} percentage="95" />
          <SkillCard skill={"React"} percentage="80" />
          <SkillCard skill={"Tailwind"} percentage="80" />
        </div>
      </div>
